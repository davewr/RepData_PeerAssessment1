...
The average value of the number of steps is ```r cmaverageStepsPerDay``` as compared to `r averageStepsPerDay` before the data set was infilled.

The median value of the number of steps is ```r cmmedianStepsPerDay``` as compared to the previous value of `r medianStepsPerDay`.
